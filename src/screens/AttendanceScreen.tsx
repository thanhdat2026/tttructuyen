                    ...
                    <div className="space-y-3 pb-20">
                        {classStudents.length > 0 ? (
                            classStudents.map(student => (
                                <div key={student.id} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row items-stretch md:items-center gap-4">
                                    <div className="flex-grow flex justify-between items-start">
                                        <div>
                                            <span className="font-bold text-base md:text-lg">{student.name}</span>
